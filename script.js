...
function nextLevel() {
    ...
    for (let i = 0; i < 5; i++) {
        ...
        if (i === winningIndex) {
            ...
            apple.innerHTML = "<img src='images/apple.png' alt='Apple' onerror='this.onerror=null; this.src=\"images/fallback-apple.png\"' />";
        } else {
...
generateBtn.addEventListener("click", () => {
    ...
    apples.forEach(apple => {
        if (!revealed && apple.dataset.winning === "true") {
            ...
            apple.innerHTML = "<img src='images/apple.png' alt='Apple' onerror='this.onerror=null; this.src=\"images/fallback-apple.png\"' />";  // Winning apple shown
            revealed = true;
        }
    });
